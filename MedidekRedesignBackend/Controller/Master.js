import { getObjectSignedUrl, medicalhistoryuploadFile, uploadFile ,deleteFile, cloudfront} from "../Middleware/s3.js";
...
const updatedoctorimgurl = async(req,res)=>{
  ...
  for(let i=0;i<alldoctors.length;i++){
    ...
    const img = "6cad8a671f7c9327c27360a7770898687f857b88c314d69ddffd91659fa159e7"
    // const imgurl ="https://d2m9x1v3tvj3q8.cloudfront.net/6cad8a671f7c9327c27360a7770898687f857b88c314d69ddffd91659fa159e7"
    await Doctor.findByIdAndUpdate({_id:id},{img:img},{new:true})
  }
...
const deleteimage =async(req,res)=>{
  deleteFile("57c1778bf63b0996a0f96feef535aaca38c99afb5b2816295ac29a30a99b740c") 
  const cfCommand = new CreateInvalidationCommand({
    DistributionId: "E32Y8GI8Q963CN",
    InvalidationBatch: {
      CallerReference: "57c1778bf63b0996a0f96feef535aaca38c99afb5b2816295ac29a30a99b740c",
      Paths: {
        Quantity: 1,
        Items: [ 
          "/" + "57c1778bf63b0996a0f96feef535aaca38c99afb5b2816295ac29a30a99b740c"
        ]
      }
    }
  })
  ...
  return res.send("file upload succesfully");

}


const uplodimage =async(req,res)=>{
  const file =req.file;
  const imageName =  generateFileName() 
  const fileBuffer = file?.buffer;
  if (fileBuffer) {
    await uploadFile(fileBuffer, imageName, file.mimetype);
    return res.send("file upoodsiddidi")
  }
}
